	...
	gcc -o main busquedasPosteriores.o cuadrado.o delay.o entradaLetras.o filtroLongitud.o generarArchivoPalabras.o imprimirPantalla.o imprimirResultados.o limites.o multipleEleccion.o primeraBusqueda.o segundaPasada.o separarPalabrasPorLetra.o stringLength.o teclado.o totalResultados.o separador.o
